...
addon_name = "TownClothes"
addon_root_folder = "TownClothes"
builds_folder = "Builds"
extra_archive_files = ["CHANGELOG.md", "LICENSE"]

version_num = 0

with open(os.path.join(addon_root_folder, "TownClothes.toc"), 'r') as toc_file:
